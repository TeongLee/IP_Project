...
<div class="w-64 bg-white shadow-md min-w-[250px] h-full max-h-screen flex flex-col">
  ...
  <div class="p-4 flex items-center border-b">
    <img
      src="https://cdn-icons-png.flaticon.com/512/5310/5310895.png"
      alt="Profile Picture"
      class="w-12 h-12 rounded-full mr-3"
    />
    <div>
      <p class="text-sm text-gray-500">SMK Batu Pahat Best Food</p>
      <h1 class="text-lg font-semibold">Bobo</h1>
    </div>
  </div>

  <!-- Menu Items -->
  <nav class="p-4 h-full flex flex-col justify-between">
    <div>
        <!-- Dashboard -->
        <div>
          <button
          ...
          <div id="dashboardMenu" class="ml-6 hidden">
            <a
              href="/schoolCoordinator/dashboard"
        ...
        <!-- Submit Application -->
        <a
          href="/student/submitApplication"
          class="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded flex items-center my-2"
        >
    ...
    <a
      href="/"
      class="block py-2 px-4 text-red-500 hover:bg-red-100 rounded flex items-center mt-4"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="w-5 h-5 mr-2"
