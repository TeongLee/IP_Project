...
<head>
  ...
  <title>District Supervisor Dashboard</title>
      ...
      <main class="p-8">
          ...
          <div class="flex justify-between items-center">
            <div>
              <div class="flex">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <span class="w-fit px-10 py-1 bg-blue-100 text-sm rounded-full text-[#3111D2] font-medium">Batu Pahat
                    PPD Staff</span>
                </div>
              </div>
            </div>
            <div class="flex-1 justify-end flex space-x-10 text-center">
              <div class="flex flex-col items-start">
                <p>Teachers</p>
                <p class="text-5xl font-bold text-blue-600">150</p>
              </div>
              <div class="flex flex-col items-start">
                <p>TVPSS Crew</p>
                <p class="text-5xl font-bold text-blue-600">780</p>
              </div>
              <div class="flex flex-col items-start">
                <p>Students</p>
                <p class="text-5xl font-bold text-blue-600">8843</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <section class="w-[75%] bg-white p-4 rounded shadow flex flex-col gap-6">
            ...
            <table class="w-full border-collapse">
              ...
              <tbody class="border text-center">
                <tr>
                  <td class="p-2 text-left border-r w-[50%]">
                    Sekolah Kebangsaan Seri Ladang, Batu Pahat
                  </td>
                ...
                <tr>
                  <td class="p-2 text-left border-r">
                    Sekolah Kebangsaan Kampung Jawa, Batu Pahat
                  </td>
                ...
                <tr>
                  <td class="p-2 text-left border-r">
                    Sekolah Kebangsaan Jelotong, Batu Pahat
                  </td>
                  <td class="text-center px-2 border-r">Version Upgrade</td>
                  <td class="text-orange-500">Pending</td>
                </tr>
                <tr>
                  <td class="p-2 text-left border-r">
                    Sekolah Kebangsaan Seri Kemajuan, Batu Pahat
                  </td>
                  <td class="text-center px-2 border-r">Resource</td>
                ...
                <tr>
                  <td class="p-2 text-left border-r">
                    Sekolah Kebangsaan Seri Maimon, Batu Pahat
                  </td>
                  <td class="text-center px-2 border-r">Version Upgrade</td>
                  <td class="text-orange-500">Pending</td>
                </tr>
                <tr>
                  <td class="p-2 text-left border-r">
                    Sekolah Kebangsaan Seri Sekawan Desa, Batu Pahat
                  </td>
                  <td class="text-center px-2 border-r">Resource</td>
                  <td class="text-teal-500">Completed</td>
                </tr>
            ...
            <div class="flex flex-col flex-1 gap-6 py-6 px-4">
              <div class="w-full flex flex-col gap-4">
                <div class="w-full items-center flex gap-6">
                  ...
                  <div>
                    <span class="text-blue-600 font-bold text-3xl leading-none block">20K</span>
                    <span class="font-medium text-lg">Views</span>
                  </div>
                </div>
                <div class="w-full flex flex-col">
                  <p>
                    School: <span class="font-semibold">SK Taman Batu 6</span>
                  </p>
                  <p>
                    Category:
              ...
              <div class="w-full flex flex-col gap-4">
                <div class="w-full items-center flex gap-6">
                  <img src="${pageContext.request.contextPath}/assets/thumbnail.jpg"
                    class="rounded-lg w-[180px] object-cover" />
                  <div>
                    <span class="text-blue-600 font-bold text-3xl leading-none block">30K</span>
                    <span class="font-medium text-lg">Views</span>
                  </div>
                </div>
                <div class="w-full flex flex-col">
                  <p>
                    School: <span class="font-semibold">SK Taman Batu</span>
                  </p>
                  <p>
                    Category:
        ...
        <div class="flex gap-4">
          ...
          <section class="w-[55%] bg-white p-4 rounded shadow flex flex-col gap-6">
            <div class="flex justify-between items-center pb-4 border-b border-dashed border-gray-300">
              <div class="flex flex-col">
                ...
                <span class="text-[#757575] uppercase text-sm">Only Show Top 5 Schools</span>
              </div>
              <div class="flex">
            ...
            <div class="flex-1 w-full flex flex-col gap-8 px-4">
              <div class="w-full flex justify-between items-center">
                <div class="flex items-center gap-3">
                  <img src="${pageContext.request.contextPath}/assets/school_logo.png"
                ...
                <div class="flex gap-12">
                  ...
                  <img src="${pageContext.request.contextPath}/assets/zoom.png"
          ...
          <section class="w-[45%] flex flex-col gap-4">
            <div class="flex flex-col gap-8 w-full h-full bg-white p-4 rounded shadow">
              <div class="flex justify-between items-center pb-4 border-b border-dashed border-gray-300">
              ...
              <div class="w-full h-full grid grid-cols-3 gap-4">
                <a class="border rounded-lg flex flex-col gap-4 items-center justify-center p-4 hover:bg-gray-100 transition-colors ease-in-out cursor-pointer"
                  href="/districtSupervisor/activityList">
                  ...
                  <div class="flex flex-col text-center space-y-2">
                    ...
                    <p class="text-sm text-gray-500 leading-tight">
                      Track the activites that organized by each school
                    </p>
                  </div>
                </a>
                <a class="border rounded-lg flex flex-col gap-4 items-center justify-center p-4 hover:bg-gray-100 transition-colors ease-in-out cursor-pointer"
                  href="/districtSupervisor/versionUpgrade">
                  ...
                  <div class="flex flex-col text-center space-y-2">
                    ...
                    <p class="text-sm text-gray-500 leading-tight">
                      Track the version upgrade request from each school
                    </p>
                  </div>
                </a>
                <a class="border rounded-lg flex flex-col gap-4 items-center justify-center p-4 hover:bg-gray-100 transition-colors ease-in-out cursor-pointer"
                  href="/districtSupervisor/resourceRequest">
                  ...
                  <div class="flex flex-col text-center space-y-2">
                    ...
                    <p class="text-sm text-gray-500 leading-tight">
                      Track the resource request from each school
                    </p>
                  </div>
                </a>
              </div>
