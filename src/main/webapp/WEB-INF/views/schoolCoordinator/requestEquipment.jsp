...
<body class="bg-gray-100 font-sans">
    <div class="flex">
        ...
        <div class="flex-1 p-6 ">
            ...
            <div class="grid grid-cols-2 gap-6 bg-white shadow-md p-6 rounded ">
            
            <!-- Left Section -->
            <div class="text-center bg-blue-50 p-6 rounded ">
                <img src="https://upload.wikimedia.org/wikipedia/ms/f/fc/4403026837235l.jpg" alt="School Logo" class="rounded-full w-60 mx-auto mb-4 mt-4">
                <h2 class="text-2xl font-bold">SMK TAMAN UNIVERSITI</h2>
                <div class="text-2xl font-bold rounded my-3 text-white bg-red-600 mx-8">Model 3</div>
                <p class="text-gray-600 text-md">Jalan Pendidikan, Taman Universiti,<br>81300 Johor Bahru, Johor</p>
            </div>
            
            <!-- Right Section -->
            <form action="/schoolCoordinator/submitEquipmentRequest" method="post" class="space-y-4">
                <h2 class="text-4xl font-medium text-center mb-7">Request Form</h2>   
                <div>
                ...
                <button type="submit" class="border border-green-600 bg-green-400 hover:bg-green-500 text-white py-2 px-4 rounded w-2/4 items-center">Submit</button>
            </form>
